...
class RedBlackTree():
	...
	print("Left/Right-----(id,Cost,Qty)-------color")
	print("")
...
if __name__ == "__main__":  
    ...
    while(True):
		...
		data = str(input("insert ID cost and Qty seperated by space"))
		data = data.split(' , ')
		#print(data)
    		bst.insert(data)
    		
    	elif(choice == "2"):
    		data = str(input ("enter node to be deleted"))
		#data = ['id' , '' , '' ]
		data = data.split(' , ')    		
		bst.delete_node(data)
    		...
    		key = input("enter the node to be search ")
    		found = bst.searchTree(key)
		if(found != ""):
			print("found")
    	else:
